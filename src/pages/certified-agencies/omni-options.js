    ...
    <div className="relative">
      <main className="px-3 pt-6 sm:px-0 sm:pt-0 relative">
          ...
          <section className="flex flex-col items-center justify-center min-h-screen relative z-10 px-4 sm:px-8 lg:px-16">
            <div className="text-center max-w-4xl mx-auto w-full">
              <div className="mb-8 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 w-full">
                ...
                >
                  <a
                    href="https://www.omnioptions.co/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block transition-opacity duration-300 hover:opacity-80"
                    aria-label="Visit Omni Options website"
                  >
                    <Image 
                      src="/assets/images/certified-members/omni_options/logo.avif" 
                      width={400} 
                      height={280} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-2 md:order-1">
                <div className="space-y-8">
                  ...
                  Omni Options is a dynamic marketing and creative agency based in Nigeria, dedicated to delivering innovative solutions that help brands connect with their audiences across Africa. As a Full Member of PAAN, we combine strategic thinking, creative excellence, and digital innovation to create impactful campaigns that drive results. Our team is committed to helping businesses grow through effective communication, brand development, and multi-channel marketing strategies.
                  </p>
        ...
        <div className="bg-white py-16 sm:py-20 relative z-10">
          <section className="relative mx-auto max-w-6xl px-4 sm:px-6">
            <h2 className="text-3xl sm:text-4xl font-bold text-paan-dark-blue text-center mb-10">Clients Omni Options Have Worked With</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 md:gap-10 items-center justify-center">
              {[1,2,3,4,5,6,7,8,].map((num) => (
                <div key={num} className="flex items-center justify-center p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                  <Image
                    src={`/assets/images/certified-members/omni_options/${num}.avif`}
                    alt={`Client logo ${num}`}
                    width={120}
                    height={60}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col items-start space-y-2">
                      ...
                      <cite className="not-italic">
                        <div className="font-semibold text-lg text-gray-900">Omni Options Team</div>
                        <div className="text-gray-600 text-sm">Omni Options</div>
                      </cite>
                    </div>
                  </div>
                </div>
      ...
      <section className="relative mx-auto max-w-4xl px-4 sm:px-6 py-10 sm:py-14">
        <div className="text-center space-y-8">
          ...
          {/* Social Media Links */}
          <div className="space-y-4">
            <p className="text-gray-600 text-sm">Follow Omni Options on social media</p>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full relative overflow-hidden shadow-xl">
            ...
            <div className="p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-semibold text-[#172840] mb-2">Contact Omni Options</h2>
