    ...
    <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-2 md:order-1">
                <div className="space-y-8">
                  ...
                  Xperia Agency is a dynamic marketing and creative agency based in Kenya, dedicated to delivering innovative solutions that help brands connect with their audiences across Africa. As a Associate Member of PAAN, we combine strategic thinking, creative excellence, and digital innovation to create impactful campaigns that drive results. Our team is committed to helping businesses grow through effective communication, brand development, and multi-channel marketing strategies.
                  </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 md:gap-10 items-center justify-center">
              {[1,2,3,4,5,6,7,8,].map((num) => (
                <div key={num} className="flex items-center justify-center p-4 bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                  <Image
                    src={`/assets/images/certified-members/xperia_agency/${num}.jpg`}
                    alt={`Client logo ${num}`}
                    width={120}
                    height={60}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col items-start space-y-2">
                      ...
                      <cite className="not-italic">
                        <div className="font-semibold text-lg text-gray-900">Xperia Agency Team</div>
                        <div className="text-gray-600 text-sm">Xperia Agency</div>
                      </cite>
                    </div>
                  </div>
                </div>
      ...
      <section className="relative mx-auto max-w-4xl px-4 sm:px-6 py-10 sm:py-14">
        <div className="text-center space-y-8">
          ...
          {/* Social Media Links */}
          <div className="space-y-4">
            <p className="text-gray-600 text-sm">Follow Xperia Agency on social media</p>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full relative overflow-hidden shadow-xl">
            ...
            <div className="p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-semibold text-[#172840] mb-2">Contact Xperia Agency</h2>
