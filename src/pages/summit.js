...
const SummitPage = () => {
  ...
  useEffect(() => {
    const targetDate = new Date('2026-10-28T00:00:00+03:00'); // October 28, 2026 at midnight EAT
  ...
  // Set target date to October 20, 2026 for Early Bird deadline
  useEffect(() => {
    const targetDate = new Date('2026-10-20T23:59:59+03:00'); // October 20, 2026 at 11:59 PM EAT
  ...
  return (
    <>
      <SEO
        ...
        twitterTitle="PAAN Summit 2026 | Creative & Tech Conference"
                  ...
                  <div className="flex-1 text-paan-dark-blue">
                    ...
                    <div className="bg-[#F3F9FB] p-4 sm:p-5 mb-6 sm:mb-8 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 border-b-2 border-paan-dark-blue ml-4 sm:ml-6">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span className="text-sm sm:text-base font-normal text-paan-dark-blue">Oct 28-29, 2026</span>
                              </div>
                      <div className="flex items-center gap-2 sm:gap-3">
               ...
               <div className="bg-gradient-to-br from-[#DAECF4] to-[#F3F9FB] rounded-xl p-4 sm:p-6 shadow-lg">
                 ...
                 <div className="space-y-3 sm:space-y-4">
                   ...
                   <div className="bg-white rounded-lg p-3 sm:p-4 shadow-md">
                     ...
                     <p className="text-paan-dark-blue text-sm sm:text-base">Oct 28-29, 2026</p>
                   </div>
                 </div>
               </div>
